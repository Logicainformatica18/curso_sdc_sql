...
go
xp_create_subdir 'c:\Datos\Hotel\Facturacion'
GO
CREATE database HOTEL
    on PRIMARY
    (NAME = 'Hotel01', FILENAME ='C:\Hotel\Hotel01.mdf',
    SIZE =20MB, MaxSize = 20GB , filegrowth =100MB),
    (NAME = 'Datos02', filename ='c:\Datos\Hotel\Datos02.ndf', Size = 30MB),

FILEGROUP FACTURACION
    (Name ='Reservas', filename = 'c:\Datos\Hotel\Facturacion\Reservas.ndf', filegrowth=50%),
    (Name ='Ventas', filename = 'c:\Datos\Hotel\Facturacion\Ventas.ndf', filegrowth=50%),
FILEGROUP PERSONAL
    (Name = 'Personal',filename = 'c:\Datos\Hotel\Facturacion\Personal.ndf', filegrowth = 50%, Size =100MB)
Log ON
...
-- funcion para cambiar el orden de las fechas
SET DATEFORMAT mdy;  
--
